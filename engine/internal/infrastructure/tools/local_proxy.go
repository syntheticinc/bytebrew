...
type LocalClientOperationsProxy struct {
	...
	confirmRequester ConfirmationRequester // if set, used for confirm_before tools
}
...
// WithConfirmRequester sets the confirmation handler for confirm_before tools.
...
// ConfirmRequester returns the confirmation requester (may be nil).
