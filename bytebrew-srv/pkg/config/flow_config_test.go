...
func TestToDomainFlow_Supervisor(t *testing.T) {
	...
	assert.Equal(t, domain.FlowTypeSupervisor, flow.Type)
	...
	assert.Equal(t, []domain.FlowType{domain.FlowTypeCoder, domain.FlowTypeReviewer}, flow.Spawn.AllowedFlows)
}
...
func TestToDomainFlow_Reviewer(t *testing.T) {
	...
	assert.Equal(t, domain.FlowTypeReviewer, flow.Type)
