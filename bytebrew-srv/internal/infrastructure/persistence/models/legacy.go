...
// Legacy models — pre-pivot. Will be removed when adapters/repositories are rewritten.
...
func (ProjectFile) TableName() string { return "project_file" }
...
func (AgentType) TableName() string { return "agent_type" }
...
// Task is the pre-pivot Task model. No collision with new TaskModel.
type Task struct {
	ID           uuid.UUID  `gorm:"type:uuid;primary_key;default:gen_random_uuid()"`
...
func (TaskArtifact) TableName() string { return "task_artifact" }
