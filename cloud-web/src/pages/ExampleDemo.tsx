        ...
        <div className="rounded-[12px] border border-brand-shade3/15 bg-brand-dark-alt p-5">
          ...
          <div className="mt-4 flex justify-center">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-[10px] border border-brand-shade3/20 px-4 py-2 text-sm text-brand-shade2 hover:text-brand-light hover:border-brand-shade3/40 transition-colors"
            >
