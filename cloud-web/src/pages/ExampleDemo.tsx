  ...
  if (!example) {
    return (
      <div className="py-24 px-4 text-center">
        <h1 className="text-2xl font-bold text-text-primary">Example not found</h1>
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-text-primary">{example.title}</h1>
              <p className="text-text-secondary mt-1">{example.subtitle}</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-[2px] border border-border bg-surface-alt p-5">
          ...
          <div className="mt-4 flex justify-center">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-[2px] border border-border px-4 py-2 text-sm text-text-secondary hover:text-text-primary hover:border-border-hover transition-colors"
            >
