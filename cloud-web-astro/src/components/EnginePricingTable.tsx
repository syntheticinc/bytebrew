...
const SHOW_EE_PRICING = import.meta.env.PUBLIC_SHOW_EE_PRICING === 'true';
...
function EnginePricingTableInner({ onSelectPlan }: EnginePricingTableProps) {
...
/** Standalone React island — includes its own QueryClientProvider */
export function EnginePricingTable({ onSelectPlan }: EnginePricingTableProps = {}) {
  return (
    <QueryClientProvider client={queryClient}>
      <EnginePricingTableInner onSelectPlan={onSelectPlan} />
    </QueryClientProvider>
  );
}

export default EnginePricingTable;
